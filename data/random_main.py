...
def file_make(folder_name):
	...
	if os.path.isdir(folder_name) == 'False':
		os.makedires(folder_name)
		os.makedires(folder_name/all)
		os.makedires(folder_name/draw)
		os.makedires(folder_name/error)
		os.makedires(folder_name/lose)
		os.makedires(folder_name/win)
